...
Процесс-менеджер будет получает текст от пользователя, разбивает текст на фрагменты и передает каждый фрагмент процессам-шифровальщикам. Шифровальщики шифруют свои фрагменты текста и записывают в общую память. Далее из этой памяти текст будет записан в файл (в коде есть комментарии).
